...
(def RULES '(
  ...
  (put-chest-on-floor
    ...
    =>
    (f/println-browser (str "Monkey throws the " ?chest " off the " ?on " onto the floor." ))
  ...
  (unlock-chest-with-key
    ...
    =>
    (f/println-browser (str "Monkey opens the " ?name " with the " ?key " revealing the " ?contents "." ))
  ...
  (grab-object-from-ladder
   ...
   =>
   (f/println-browser (str "Monkey grabs the " ?name "." ))
  ...
  (drop-object
    ...
    =>
    (f/println-browser (str "Monkey drops the " ?name "." ))
    (modify ?monkey holding blank)
  ...
  (walk-holding-nothing
    ...
    ?monkey (monkey location ?loc on-top-of floor holding blank
      (not= ?loc ?place))
    =>
    (f/println-browser (str "Monkey walks to " ?place "." ))
  ...
  (walk-holding-object
    ...
    ?monkey (monkey location ?loc on-top-of floor holding ?obj
      ((not= ?loc ?place)
       (not= ?obj blank)))
    =>
    (f/println-browser (str "Monkey walks to " ?place " holding the " ?obj "." ))
    (modify ?monkey location ?place)
    (retract ?goal))
  ...
  (jump-onto-floor
    ...
    ?monkey (monkey on-top-of ?on
      (not= ?on floor))
    =>
    (f/println-browser (str "Monkey jumps off the " ?on " onto the floor." ))
  ...
  (climb-directly
    ...
    ?monkey (monkey location ?place on-top-of ?on holding blank)
    =>
    (f/println-browser (str "Monkey climbs onto the " ?obj "." ))
  ...
  (satisfy-hunger
    ...
    ?thing (thing name ?name)
    =>
    (f/println-browser (str "Monkey eats the " ?name "." ))
    (modify ?monkey holding blank)
    (retract ?goal ?thing))
              ))
